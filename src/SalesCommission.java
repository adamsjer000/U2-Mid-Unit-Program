...
//
     /* THE PLAN
         ...
         3. Calculate the hours worked
         4. Calculate the sales commission percent
         5. Calculate the total sales of a salesperson and their total earnings
         6. Display results/output
...
public class SalesCommission {
    ...
    public static void main(String[] args) {
        ...
        double hourlyPay = getInput("How many hours did you work ?");
        double carSales = getInput("How many cars did you sale ?");
        double salesCommission = getInput("What is the sales commission");
        double hourlyRate = getInput("How much do you get paid a hour ?");
    }
   ...
   public static double commission (double carSales, double salesCommission){
        return carSales + salesCommission;
   }
